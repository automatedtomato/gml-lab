...
#define CHECK_INT32(x) TORCH_CHECK(x.dtype() == torch::kInt32, "must be int32 tensor")
...
extern torch::Tensor quant_linear(const torch::Tensor &input,
                                  ...
                                  bool is_per_channel);
extern torch::Tensor
fused_quant_conv(const torch::Tensor &input, const torch::Tensor &weight,
                 std::optional<torch::Tensor> bias, torch::IntArrayRef stride,
